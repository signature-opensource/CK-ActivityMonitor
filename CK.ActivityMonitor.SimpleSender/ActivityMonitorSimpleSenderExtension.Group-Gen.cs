    ...
    public static partial class ActivityMonitorSimpleSenderExtension
    {
        ...
        public static IDisposableGroup OpenDebug( this IActivityMonitor monitor, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            var d = monitor.ShouldLogGroup( LogLevel.Debug, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber, true )
                                                : default;
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Debug, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            ...
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Debug | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Debug, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Debug | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        public static IDisposableGroup OpenTrace( this IActivityMonitor monitor, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            var d = monitor.ShouldLogGroup( LogLevel.Trace, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d ); 
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Trace, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Trace | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Trace, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Trace | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        public static IDisposableGroup OpenInfo( this IActivityMonitor monitor, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            var d = monitor.ShouldLogGroup( LogLevel.Info, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d ); 
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Info, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Info | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Info, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Info | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        public static IDisposableGroup OpenWarn( this IActivityMonitor monitor, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            var d = monitor.ShouldLogGroup( LogLevel.Warn, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d ); 
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Warn, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Warn | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Warn, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Warn | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        public static IDisposableGroup OpenError( this IActivityMonitor monitor, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            var d = monitor.ShouldLogGroup( LogLevel.Error, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d ); 
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Error, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Error | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Error, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Error | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        public static IDisposableGroup OpenFatal( this IActivityMonitor monitor, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            var d = monitor.ShouldLogGroup( LogLevel.Fatal, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d ); 
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Fatal, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Fatal | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Fatal, null, out var finalTags )
                                                ? monitor.CreateActivityMonitorLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber, true )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.CreateActivityMonitorLogData( LogLevel.Fatal | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber, true )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
